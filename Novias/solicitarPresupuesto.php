...
if (isset($_POST['fechaBoda']) && isset($_POST['detalles'])) {
  function validar($data){
    ...
    if ($queryAgregar) {
        echo "<script>alert('Cotizacion enviada, porfavor espera la respuesta del proveedor'); window.location='panelGeneral.php?idUsuario=$idUsuarioEncriptado&idBoda=$idBodaEncriptado';</script>";
    } else {
...
<div class="container d-flex justify-content-center">
  <form action="solicitarPresupuesto.php?idUsuario=<?php echo $idUsuarioEncriptado; ?>&idBoda=<?php echo $idBodaEncriptado; ?>&idServicio=<?php echo $idServicioEncriptado; ?>" method="POST" class="w-50">
